...
#define val_true  1 //((0 << char_shift) | nonchar_type_tag)
#define val_false 0 // ((1 << char_shift) | nonchar_type_tag)
#define val_eof   1114112
#define val_void  0 //((3 << char_shift) | nonchar_type_tag)
